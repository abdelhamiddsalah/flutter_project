...
import 'package:flutter_project/Features/Authentication/Presentation/Views/widgets/Profile_view_body.dart';
...
class ProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AuthCubitCubit(Dioconsumer(dio: Dio()))..getProfile(),
